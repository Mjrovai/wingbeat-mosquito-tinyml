/* 
 * Mic Graph test  
 * Based on Lakshantha Wio Terminal Classroom #9 | Built-In Hardware/ Sensors Part 2 | Microphone & Buzzer 
 * https://github.com/lakshanthad/Wio_Terminal_Classroom_Arduino/blob/main/Classroom%209/mic_graph/mic_graph.ino
 * 
 */
